...
//          ID: 12370346
// Date:        10/04/2015
// Description: Methods for the vector class.
// See also:    Vector.h
...
vector &vector::operator=(const vector &b)
{
    ...
    delete [] entries; // Just in case there was any memory already allocated to this
...
//Overloading the << operator so we can use vectors with cout directly
