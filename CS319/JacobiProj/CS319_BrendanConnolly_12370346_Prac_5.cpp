...
//ID: 12370346
//Date: 4/3/15
//Description: This program implements the Jacobi method and the Gauss-Seidal method to solve systems of linear equations.
...
int main(void)
{
    ...
    for (unsigned int i=0; i<N; i++)
    {
        ...
        x.seti(i, 1.5);     //Set  teh vector x to be 1.5 at all of its entries
    }
